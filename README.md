...
## Exercise 0 - Google Doc OpenGL Tutorial - Triangle, Square
...
Decoder, Rendering faces (triangles) wireframes ok.
...
## Exercise 4 - Loader (STL) Work in progress
